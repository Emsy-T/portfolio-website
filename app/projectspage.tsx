              ...
              <Card className='bg-white shadow-lg border-0'>
                <CardContent className='p-8'>
                  <p className='text-slate-600 leading-relaxed text-lg'>
                    ...
                    during what should’ve been my 11th grade, I’ve overcome trauma,
                    and faced emotional scars from a flawed school system—but I
                    kept going. I’ve learned to grow in spite of challenges by
                    shaping my mindset and pursuing my passions. I have a lot of
                    passions! I build apps, write music, design original
                    characters, write stories, do a bit of 3D animation, and
                    advocate for environmental sustainability as wella as youth
                    empowerment. I believe the biggest challenge youths face
                    today is building the right mindset, and I want to change
                    that through tech, creativity, and entrepreneurship. Over
                    the last three years, I’ve been active in Technovation. I
                    competed in the Technovation Girls Challenge for the 2023
